...
1. Keyboard shortcut for Scenes 1–9 (⌘+digit)
1. Keyboard shortcut for next or previous scenes
    * ⌘ → Next (higher number, lower in Scenes window) 
    * ⌘ ← Previous (lower numbers, higher in Scenes window)
...
1. Scene ➝ Duplicate Current Scene…
...
* Press Delete. Or click the trash can icon. 

Trash a scene by mistake? Don't panic. Edit ➝ Undo. Or ⌘Z.
...
1. **Drag and drop** - select one or more scenes in the Scenes window, and drag them to the Desktop. To select more than one at once, hold the shift key while clicking each scene.
