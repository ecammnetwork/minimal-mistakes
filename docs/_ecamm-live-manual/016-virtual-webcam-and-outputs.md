...
Activate Virtual Mic by choosing <samp>On</samp> in <samp>Outputs</samp> ➝ <samp>Virtual Mic</samp>. It can also be activated using <samp>Virtual Cam</samp> toggle in the Mode menu at the top of the Main Window. (See above.)
